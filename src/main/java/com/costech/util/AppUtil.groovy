...
class AppUtil {
     ...
     * @return
     */
    static boolean checkParam(String method, PageData pd){
     ...
     * @return
     */
    static PageData setPageParam(PageData pd){
     ...
     * @return
     */
    static List<PageData>  setListDistance(List<PageData> list, PageData pd){
     ...
     * @return
     */
    static Object returnObject(PageData pd, Map map){
