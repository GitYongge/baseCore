...
class Const {
    ...
    public static
    final String NO_INTERCEPTOR_PATH = ".*/((login)|(logout)|(code)|(app)|(weixin)|(static)|(main)|(websocket)|(uploadImgs)).*"
    //不对匹配该值的访问路径拦截（正则）
     ...
     */
    //系统用户注册接口_请求协议参数)
    public static final String[] SYSUSER_REGISTERED_PARAM_ARRAY = ["USERNAME", "PASSWORD", "NAME", "EMAIL", "rcode"]
    public static final String[] SYSUSER_REGISTERED_VALUE_ARRAY = ["用户名", "密码", "姓名", "邮箱", "验证码"]
